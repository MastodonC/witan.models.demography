...
(def migration-data (ld/load-datasets {:domestic-in-migrants
                                       "dev-resources/test_data/migration/bristol_dom_in_mig.csv"
                                       :domestic-out-migrants
                                       "dev-resources/test_data/migration/bristol_dom_out_mig.csv"
                                       :international-in-migrants
                                       "dev-resources/test_data/migration/bristol_inter_in_mig.csv"
                                       :international-out-migrants
                                       "dev-resources/test_data/migration/bristol_inter_out_mig.csv"}))
...
(def dom-in-averages (ld/load-dataset :dom-in-averages
                                      "dev-resources/test_data/migration/bristol_dom_in_avg.csv"))

(def dom-out-averages (ld/load-dataset :dom-out-averages
                                       "dev-resources/test_data/migration/bristol_dom_out_avg.csv"))

(def inter-in-averages (ld/load-dataset :inter-in-averages
                                        "dev-resources/test_data/migration/bristol_inter_in_avg.csv"))

(def inter-out-averages (ld/load-dataset :inter-out-averages
                                         "dev-resources/test_data/migration/bristol_inter_out_avg.csv"))
