...
;; Load testing data
(def test-data-paths {:births-data "test_data/bristol_births_data.csv"
                      :at-risk-popn "test_data/bristol_denominators.csv"
                      :hist-births-est "test_data/bristol_hist_births_est.csv"})
